// mini-pages.js
//   Responsável por controlar todos os carousels de imagem nas mini-páginas.
//   Código encapsulado para evitar conflito com o script principal.
(function(){
  ...
  carousels.forEach((carousel) => {
    ...
    window.addEventListener('resize', ()=>{
      clearTimeout(window._miniCarouselResize);
      window._miniCarouselResize = setTimeout(update, 100);
    });
    update();
    startAutoplay();
  });
